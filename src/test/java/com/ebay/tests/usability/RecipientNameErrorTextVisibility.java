...
public class RecipientNameErrorTextVisibility extends BaseTest {
    ...
    public void testAddToCart() throws InterruptedException {
        try {
            ...
            Thread.sleep(3000);
            // Click on another element to make the error message appear
            driver.findElement(By.xpath("//*[@id=\"recipient_email\"]")).click();

            WebElement element = driver.findElement(By.xpath("/html/body/div[1]/div/div/div[3]/div/div[2]/div/div/div/div[2]/div[2]/div/div/form/div[2]/div[2]/div"));
